...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(['prefix' => 'employees'], function () {
        Route::get('/create/{company}', [EmployeeController::class, 'create'])->name('employees.create');
        Route::post('/store/{company}', [EmployeeController::class, 'store'])->name('employees.store');
